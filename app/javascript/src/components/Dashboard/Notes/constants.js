export const INITIAL_NOTE_LIST = [
  {
    ...
    categories: [{ id: 1, label: "Shopping Cart" }],
    createdBy: {
      name: "Oliver Smith",
  ...
  },
  {
    ...
    categories: [{ id: 2, label: "Product Management" }],
    createdBy: { name: "John Eve", imageUrl: "https://i.pravatar.cc/300/2" },
  },
  {
    ...
    createdBy: { name: "Eve smith", imageUrl: "https://i.pravatar.cc/300/3" },
  },
  {
    ...
    createdBy: { name: "Sam John", imageUrl: "https://i.pravatar.cc/300/4" },
  },
  {
    title: "Understanding Product Categories",
    description:
      "Explore different product categories available on our platform to easily find the items you need.",
    updatedAt: "2023-11-21T14:00:00Z",
    categories: [{ id: 2, label: "Product Management" }],
    createdBy: { name: "John Simon", imageUrl: "https://i.pravatar.cc/300/5" },
  },
];
